...
class MyTestCase(unittest.TestCase):
    @patch('basic_list_exception_assignment.basic_list_exceptions.get_input', return_value='5')  # This test will validate that the input is correct.
    def test_make_list(self, input):
        self.assertEqual(basic_list_exceptions.make_list(), [5, 5, 5])
